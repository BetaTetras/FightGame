...
int MenuArme()
{
    ...
    std::cout << "1 - Epee de bois (D = 20 ; C = 1/2 )      2 - Baton de bois (D = 10 ; C = 1/3 ; E = +1 )       3 - Retour" << '\n';
    std::cout << '\n';
    std::cout << "      > ";
    std::cin >> Choix;
    output = Verif(1,3,Choix);
...
int MenuMagie()
{
    ...
    std::cout << "1 - Boule de feu (D = -30 ; C = 1/3 )      2 - Dard empoisonne  (D = -5 ; C = 1/5 ; E = -5 * 5 )       3 - Retour" << '\n';
    std::cout << '\n';
    std::cout << "      > ";
    std::cin >> Choix;
...
int MenuObjet()
{
    ...
    std::cout << "1 - Potion suspecte (1/2 +30PV , 1/2 -20PV)       2 - Retour" << '\n';
    std::cout << '\n';
    std::cout << "      > ";
    std::cin >> Choix;
...
{   
    ...
    while(Exit == false && TourJouer == false)
    {
        switch (MenuCombat())
        {
            case 1:
